...
export default async function page() {
  const { data: rooms } = await getUserChatRoom();
  return (
    <div className="grid grid-cols-3 gap-2 p-4">
      ...
      <div className="col-span-2 flex h-[calc(100svh-90px)] w-full items-center justify-center overflow-hidden rounded-sm bg-accent">
